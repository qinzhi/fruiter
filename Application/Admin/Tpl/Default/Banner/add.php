                                    ...
                                    <div class="tab-pane active" id="tab-basic">
                                        <table class="table-form">
                                            ...
                                            <tr>
                                                <th>链接地址：</th>
                                                <td>
                                                    <input class="form-control Lwidth400" id="link" name="link" value="0" pattern="required" type="text" maxlength="255">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>开始和结束时间：</th>
                                                <td>
                                                    <input class="form-control Lwidth400" id="valid_time" pattern="required" type="text" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>排序：</th>
