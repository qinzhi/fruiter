...
<head>
    ...
    <script type="text/javascript" src="/Public/Static/js/jquery.min.js"  media="all"></script>
    <script type="text/javascript" src="/Public/Admin/js/jquery.websocket.js"  media="all"></script>
    <script type="text/javascript">
        WS_STATIC_URL = '/Public/Admin';
        WS_HOST = '127.0.0.1';
        WS_PORT = 843;
